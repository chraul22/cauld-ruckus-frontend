...
class Auth {
  ...
  async signIn(userData) {
    ...
    // redirect based on new user or returning
    _Router.default.init();
    if (data.user.newUser == true) {
      (0, _Router.gotoRoute)('/aboutus');
    } else {
      (0, _Router.gotoRoute)('/');
    }
  }
  async check(success) {
    ...
    if (!localStorage.accessToken) {
      // no local token!
      _Toast.default.show("Sign in, do it, we're really excited!");
...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js"}],"ArticleAPI.js":[function(require,module,exports) {
"use strict";
...
class ArticleAPI {
  async getArticles() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
  ...
  async submitArticles() {
    let articleData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'form';
    try {
      const response = await fetch("".concat(_App.default.apiBase), {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        _Toast.default.show('Article submitted successfully!');
      ...
      _Toast.default.show('Failed to submit article!', 'error');
      throw err;
    }
  }
  async updateArticle(articleId, data) {
    let dataType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'json';
    try {
      let responseHeader;
      if (dataType === 'form') {
        responseHeader = {
      ...
      const response = await fetch("".concat(_App.default.apiBase, "/articles/").concat(articleId), responseHeader);
      if (response.ok) {
        const updatedArticle = await response.json();
        console.log('Article updated:', updatedArticle);
        _Toast.default.show('Article updated successfully!');
      ...
      _Toast.default.show('Failed to update article!', 'error');
      throw err;
    }
  }
}
var _default = new ArticleAPI();
exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/articles.js":[function(require,module,exports) {
"use strict";
...
class ArticleView {
  ...
  async getArticles() {
    try {
      this.articles = await _ArticleAPI.default.getArticles();
  ...
  renderParagraphs(paragraphs) {
    return paragraphs.map(p => (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<p>", "</p>"])), p));
  }
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <va-app-header user=\"", "\"></va-app-header>\n      <div class=\"page-content\">\n      <div class = \"cards-col\">\n        ", "\n      </div>\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), this.articles == null ? (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([""]))) : (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n              ", "\n        "])), this.articles.map(article => (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n            <sl-card class=\"article-card\">\n            <img \n              src=\"", "/images/", "\" \n              alt=\"", "\" slot=\"image\"\n              >\n              <h2>", "</h2>\n             <p> ", "</p>\n            </sl-card>\n          "])), _App.default.apiBase, article.heroImage, article.title, article.title, this.formatContentIntoParagraphs(article.content)))));
    (0, _litHtml.render)(template, document.querySelector('#root'));
  }
}
var _default = new ArticleView();
exports.default = _default;
},{"lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../App":"App.js","../../ArticleAPI":"ArticleAPI.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
class Subs {
  ...
  async submitArticle(userData) {
    let fail = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    const response = await fetch("".concat(_App.default.apiBase, "/articles"), {
      method: 'POST',
      body: content
    });
    ...
    if (!response.ok) {
      ...
      if (err) console.log(err);
      // show error      
      _Toast.default.show("Problem submitting article: ".concat(response.status));
      // run fail() functon if set
      if (typeof fail == 'function') fail();
    }
    /// sign up success - show toast and redirect to sign in page
    _Toast.default.show('You made a submission on the internet!');
    // redirect to signin
    (0, _Router.gotoRoute)('/');
  }
}
var _default = new Subs();
exports.default = _default;
},{"./App":"App.js","./Router":"Router.js","./views/partials/splash":"views/partials/splash.js","lit-html":"../node_modules/lit-html/lit-html.js","./Toast":"Toast.js"}],"views/pages/submissions.js":[function(require,module,exports) {
"use strict";
...
var _Router = require("./../../Router");
var _Utils = _interopRequireDefault(require("./../../Utils"));
var _Subs = _interopRequireDefault(require("../../Subs"));
var _ArticleAPI = _interopRequireDefault(require("../../ArticleAPI"));
var _templateObject;
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
class SubmissionsView {
  ...
  articleSubmitHandler(e) {
    ...
    submitBtn.setAttribute('loading', '');
    const formData = e.detail.formData;
    _ArticleAPI.default.submitArticles(formData, () => {
      submitBtn.removeAttribute('loading');
    });
  }
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Profile\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">\n        <h3 class=\"--heading-color\">\n          Hey ", "! Just below is where you can submit an article and our super talented and sexy editors will look over it soon!\n        </h3>\n        <sl-form class=\"form-submit\" @sl-submit=\"", "\">\n          <div class=\"input-group\">\n            <sl-input name=\"Submission\" type=\"text\" placeholder=\"Working Title\" required></sl-input>\n          </div>\n          <div class=\"input-group\">\n            <sl-textarea name=\"Submission\" type=\"text\" placeholder=\"Paste your well written, well edited 'art' here...\" required></sl-textarea>\n          </div>\n          <sl-button class=\"sub-article\" type=\"primary\" @click=\"", "\">Submit, if it's not awful!</sl-button>\n        </sl-form>\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, this.articleSubmitHandler, this.articleSubmitHandler);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new SubmissionsView();
exports.default = _default;
},{"./../../App":"App.js","./../../Auth":"Auth.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Utils":"Utils.js","../../Subs":"Subs.js","../../ArticleAPI":"ArticleAPI.js"}],"views/pages/review.js":[function(require,module,exports) {
"use strict";
...
class ReviewView {
  ...
  async getArticles() {
    try {
      ...
      if (_Auth.default.currentUser.accessLevel !== 2) {
      ...
      _Toast.default.show(err, 'error');
      console.log(_Toast.default.show);
    }
  }
  renderParagraphs(paragraphs) {
    return paragraphs.map(p => (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<p>", "</p>"])), p));
  ...
  async updateArticleStatusHandler(articleId, status) {
    try {
      const updatedArticle = await _ArticleAPI.default.updateArticle(articleId, {
        status
      });
      this.articles = await _ArticleAPI.default.getArticles();
      this.articles = this.articles.filter(article => article.status === 'pending');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <va-app-header user=\"", "\"></va-app-header>\n      <div class=\"page-content\">\n        <div class=\"cards-col\">\n          ", "\n        </div>\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), this.articles == null ? (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([""]))) : (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n                ", "\n              "])), this.articles.map(article => (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n                  <sl-card class=\"article-card\" data-article-id=\"", "\">\n                    <img src=\"", "/images/", "\" alt=\"", "\" slot=\"image\">\n                    <h2>", "</h2>\n                    <p>", "</p>\n                    <div>\n                      <sl-button class=\"approve-btn\" @click=\"", "\">Approve</sl-button>\n                    </div>\n                    <div>\n                      <sl-button class=\"reject-btn\" @click=\"", "\">Reject</sl-button>\n                    </div>\n                  </sl-card>\n                "])), article._id, _App.default.apiBase, article.heroImage, article.title, article.title, this.formatContentIntoParagraphs(article.content), () => this.updateArticleStatusHandler(article._id, 'approved'), () => this.updateArticleStatusHandler(article._id, 'pending')))));
    (0, _litHtml.render)(template, document.querySelector('#root'));
  }
}
var _default = new ReviewView();
exports.default = _default;
},{"lit-html":"../node_modules/lit-html/lit-html.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../App":"App.js","../../ArticleAPI":"ArticleAPI.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _articles = _interopRequireDefault(require("./views/pages/articles"));
...
var _submissions = _interopRequireDefault(require("./views/pages/submissions"));
var _review = _interopRequireDefault(require("./views/pages/review"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// import views
...
const routes = {
  ...
  '/submissions': _submissions.default,
...
},{"./views/pages/articles":"views/pages/articles.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/aboutUs":"views/pages/aboutUs.js","./views/pages/submissions":"views/pages/submissions.js","./views/pages/review":"views/pages/review.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
var _ArticleAPI = _interopRequireDefault(require("./ArticleAPI.js"));
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  _App.default.init(resultsEl);
});
},{"./App.js":"App.js","./ArticleAPI.js":"ArticleAPI.js","./components/va-app-header":"components/va-app-header.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];

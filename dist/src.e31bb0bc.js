...
class Auth {
  ...
  async signIn(userData) {
    ...
    this.currentUser = data.user; // redirect based on new user or returning
  ...
  async check(success) {
    ...
    if (!localStorage.accessToken) {
      // no local token!
      _Toast.default.show("Sign in, do it, we're really excited!"); // redirect to sign in page      
...
class ArticleView {
  ...
  renderParagraphs(paragraphs) {
    return paragraphs.map(p => (0, _litHtml.html)(_templateObject(), p));
  }
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject2(), JSON.stringify(_Auth.default.currentUser), this.articles == null ? (0, _litHtml.html)(_templateObject3()) : (0, _litHtml.html)(_templateObject4(), this.articles.map(article => (0, _litHtml.html)(_templateObject5(), _App.default.apiBase, article.heroImage, article.title, article.title, this.formatContentIntoParagraphs(article.content)))));
...
class aboutUsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/submissions'), () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class Subs {
  ...
  async submitArticle(userData) {
    ...
    if (!response.ok) {
      ...
      _Toast.default.show("Problem submitting article: ".concat(response.status)); // run fail() functon if set
    ...
    _Toast.default.show('You made a submission on the internet!'); // redirect to signin
...
class SubmissionsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, this.articleSubmitHandler, this.articleSubmitHandler);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class ReviewView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject2(), JSON.stringify(_Auth.default.currentUser), this.articles == null ? (0, _litHtml.html)(_templateObject3()) : (0, _litHtml.html)(_templateObject4(), this.articles.map(article => (0, _litHtml.html)(_templateObject5(), article._id, _App.default.apiBase, article.heroImage, article.title, article.title, this.formatContentIntoParagraphs(article.content), () => this.updateArticleStatusHandler(article._id, 'approved'), () => this.updateArticleStatusHandler(article._id, 'pending')))));
    (0, _litHtml.render)(template, document.querySelector('#root'));
  }
